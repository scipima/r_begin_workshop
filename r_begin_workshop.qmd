...
Depending on the overall level, we might not cover all the content - that's ok, you still get this document if you want to explore furher. 
* I won't be able to enter any detail about R itself, statistics, or visualisation - and that's also ok. 
...
my_packages <- c(
    "tidyverse", "broom", "coefplot", "cowplot",
...
comm_doc_count |>
    ...
    dplyr::mutate(document_creator_organization = forcats::fct_reorder(
        document_creator_organization, doc_count,
        .fun = max
    )) |>
